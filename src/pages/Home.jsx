      ...
      <main id="main-content" tabIndex={-1} className="w-full overflow-x-hidden">
          ...
          <div className="lc-shell py-14 sm:py-16 lg:py-20">
            ...
            <div className="grid gap-10 lg:grid-cols-[minmax(0,0.94fr)_minmax(22rem,0.86fr)] lg:items-center lg:gap-12">
              <MotionReveal yOffset={25} className="max-w-[38rem]">
                <p className="lc-eyebrow">Grup perusahaan distribusi, retail, sub retail, dan lifestyle</p>
                <h1 className="mt-4 max-w-full sm:max-w-[12ch] font-display text-[clamp(2.65rem,4.7vw,4.1rem)] font-[500] leading-[0.94] tracking-[-0.05em] text-[#171a22]">Ocean Space menjalankan empat unit bisnis dengan tata kelola dan eksekusi yang jelas.</h1>
                <p className="mt-5 max-w-[33rem] text-[1rem] leading-8 text-[#556070]">Tim kami memakai satu standar operasi untuk kemitraan, ekspansi, dan keputusan sehari-hari.</p>
              ...
              <MotionReveal delay={0.15} yOffset={30} className="relative mx-auto w-full max-w-[36rem]">
                {/* Ultra-Clean Vector/Bento Wrapper */}
                <div className="relative overflow-hidden rounded-3xl bg-slate-50 border border-slate-200/60 p-2 sm:p-4 shadow-sm">
                    ...
                    <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm flex flex-col">
                      <div className="flex items-center justify-between border-b border-slate-100 px-5 py-4 text-sm bg-white">
                        <div className="flex items-center gap-3">
                          <span className="os-pulse-dot h-2 w-2 rounded-full bg-[#FF2D20] text-[#FF2D20]"></span>
                  ...
                  <div className="relative z-10 mt-3 sm:mt-4 grid gap-3 rounded-2xl border border-slate-200 bg-white px-5 py-4 text-sm font-medium text-slate-600 shadow-sm sm:grid-cols-[minmax(0,1fr)_auto] sm:items-center">
                    ...
                    <div className="flex items-center gap-2">
                      <span className="os-pulse-dot h-2 w-2 rounded-full bg-[#0062FF] text-[#0062FF]"></span>
        ...
        <section className="lc-band bg-white">
          <div className="lc-shell relative py-16 sm:py-20 lg:py-24">
            <MotionReveal className="mx-auto max-w-[54rem] text-center">
            ...
            <div className="grid gap-10 lg:grid-cols-[minmax(0,0.76fr)_minmax(0,1.24fr)] lg:items-start">
              <MotionReveal className="max-w-[29rem]">
                ...
                <div className="mt-8 grid gap-3 sm:grid-cols-3">
                  <MotionCard className="border border-[#d9e2ef] bg-white px-4 py-4">
              ...
              <MotionReveal delay={0.12} className="relative overflow-hidden rounded-3xl border border-slate-200/60 bg-slate-50 p-2 sm:p-4 shadow-sm">
                <div className="relative z-10 grid overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm lg:grid-cols-[minmax(14rem,0.85fr)_minmax(0,1.15fr)]">
                  ...
                  <div className="px-6 py-8 sm:px-8 bg-white">
                    ...
                    <MotionStagger className="mt-6 grid gap-4 sm:grid-cols-2">
                      <MotionStaggerItem>
                        <MotionCard className="group rounded-xl border border-slate-100 bg-slate-50 px-5 py-5">
        ...
        <section className="lc-band bg-white">
          <div className="lc-shell relative py-14 sm:py-16 lg:py-20">
            <div className="grid gap-10 lg:grid-cols-[minmax(0,0.74fr)_minmax(0,1.26fr)] lg:items-start">
              <MotionReveal className="max-w-[28rem]">
              ...
              <MotionReveal delay={0.12} className="overflow-hidden border border-[#d9e2ef] bg-[#f8fbff]">
                <div className="grid lg:grid-cols-[minmax(0,1.08fr)_minmax(14rem,0.92fr)]">
                  <div className="border-b border-black/10 bg-white px-5 py-5 lg:border-b-0 lg:border-r">
                    ...
                    <MotionStagger className="mt-4 grid gap-3 sm:grid-cols-2">
                      <MotionStaggerItem>
                        <MotionCard className="border border-[#d9e2ef] bg-[#f8fbff] px-4 py-4">
            ...
            <div className="grid gap-10 lg:grid-cols-[minmax(0,0.74fr)_minmax(0,1.26fr)] lg:items-start">
              <MotionReveal className="max-w-[28rem]">
                ...
                <div className="mt-7 flex flex-wrap gap-3">
                  <MotionButton>
                    <a href="/career" className="inline-flex min-h-[44px] items-center justify-center rounded-md bg-[#2563eb] px-5 text-sm font-semibold text-white transition-colors hover:bg-[#1d4ed8]">Buka halaman karier</a>
                  </MotionButton>
                  <MotionButton>
                    <a href="/about" className="inline-flex min-h-[44px] items-center justify-center rounded-md border border-black/10 bg-white px-5 text-sm font-semibold text-[#151821] transition-colors hover:border-black/20">Pelajari budaya JUJUR</a>
                  </MotionButton>
                </div>
              </MotionReveal>
              <MotionReveal delay={0.12} className="overflow-hidden border border-[#d9e2ef] bg-white">
        ...
        <section className="lc-band bg-white">
          <div className="lc-shell relative py-14 sm:py-16 lg:py-20">
            <MotionStagger className="mt-10 grid gap-0 border-y border-black/10 lg:grid-cols-3">
              <MotionStaggerItem>
                <MotionCard className="relative border-b border-black/10 bg-white p-6 sm:p-8 lg:border-b-0 lg:border-r h-full">
              ...
              <MotionStaggerItem>
                <MotionCard className="relative border-b border-black/10 bg-[#f8fbff] p-6 sm:p-8 lg:border-b-0 lg:border-r h-full">
              ...
              <MotionStaggerItem>
                <MotionCard className="relative bg-white p-6 sm:p-8 h-full">
          ...
          <div className="lc-shell relative py-16 sm:py-20 lg:py-24">
            <MotionReveal className="mx-auto max-w-[42rem] text-center">
              ...
              <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
                ...
                <MotionButton>
                  <a href="/career" className="inline-flex min-h-[44px] items-center justify-center rounded-md border border-black/10 bg-white px-5 text-sm font-semibold text-[#151821] transition-colors hover:border-black/20">Lihat peluang karier</a>
                </MotionButton>
              </div>
            </MotionReveal>
          </div>
