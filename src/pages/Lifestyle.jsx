  ...
  <main className="w-full overflow-x-hidden">
    <section className="lc-band bg-white">
      <div className="lc-shell py-14 sm:py-16 lg:py-20">
        ...
        <div className="grid gap-10 lg:grid-cols-[minmax(0,0.96fr)_minmax(22rem,0.84fr)] lg:items-center lg:gap-12">
          <div className="lc-hero-copy max-w-[40rem]">
              ...
              <div className="lc-brand-grid">
                <article className="lc-brand-card">
                  <div className="lc-brand-mark">
                    <img src="images/unit-mari-sukses-gemilang.png" alt="Logo PT. Mari Sukses Gemilang" loading="lazy" decoding="async" />
                  </div>
                  <p className="lc-brand-name">PT. Mari Sukses Gemilang</p>
                </article>
              </div>
            </div>
            <div data-motion-enter="actions" className="lc-hero-actions mt-8 flex flex-wrap items-center gap-4">
              ...
              <a href="/career" data-motion-cta="true" className="inline-flex min-h-[44px] items-center justify-center rounded-md border border-[#d4dbe6] bg-[#f7f9fc] px-5 text-sm font-semibold text-[#243041] transition-colors hover:border-[#2563eb]/35 hover:text-[#1d4ed8]">Lihat peluang karier</a>
            </div>
          </div>
              ...
              <div className="relative z-10 grid gap-3 sm:gap-4 sm:grid-cols-[minmax(0,1.2fr)_minmax(11rem,0.8fr)]">
                <div className="flex flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
                  <div className="flex items-center justify-between border-b border-slate-100 px-5 py-4 text-sm bg-white">
                    <div className="flex items-center gap-3"><span className="h-2 w-2 rounded-full bg-[#10b981] shadow-[0_0_8px_rgba(16,185,129,0.4)]"></span><span className="font-bold tracking-tight text-slate-900">Lifestyle Matrix</span></div>
                  ...
                  <div className="relative flex-1 overflow-hidden bg-white flex items-center justify-center p-0 aspect-[1.12/1]">
                    <img src="images/lifestyle_hero_cover.png" alt="Dashboard Lifestyle Ocean Space" className="h-full w-full object-cover transition-transform duration-1000 hover:scale-105" loading="eager" fetchpriority="high" />
                  </div>
                </div>
                <div className="grid gap-3 sm:gap-4">
                  <div className="group rounded-2xl border border-slate-200 bg-white px-6 py-5 shadow-sm transition-all duration-300 hover:border-slate-300 hover:shadow-md"><p className="font-mono text-[0.66rem] uppercase tracking-widest text-slate-500 transition-colors group-hover:text-[#10b981]">Entitas</p><p className="mt-2 text-[2.5rem] font-extrabold tracking-tight text-slate-900 leading-none">1</p></div>
                  <div className="group rounded-2xl border border-slate-200 bg-white px-6 py-5 shadow-sm transition-all duration-300 hover:border-slate-300 hover:shadow-md"><p className="font-mono text-[0.66rem] uppercase tracking-widest text-slate-500 transition-colors group-hover:text-slate-800">Visi</p><p className="mt-2 text-[1.5rem] font-extrabold tracking-tight text-slate-900 leading-none">Dipercaya</p></div>
                  <div className="group rounded-2xl border border-slate-200 bg-white px-6 py-5 shadow-sm transition-all duration-300 hover:border-slate-300 hover:shadow-md"><p className="font-mono text-[0.66rem] uppercase tracking-widest text-slate-500 transition-colors group-hover:text-slate-800">Kinerja</p><p className="mt-2 text-[1.4rem] font-extrabold tracking-tight text-slate-900 leading-none">Unggul</p></div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div data-motion-reveal="panel" className="relative overflow-hidden rounded-3xl border border-slate-200/60 bg-slate-50 p-2 sm:p-4 shadow-sm">
            <div className="relative z-10 grid overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm lg:grid-cols-[minmax(14rem,0.85fr)_minmax(0,1.15fr)]">
              <div className="relative overflow-hidden border-b border-slate-100 bg-slate-50 lg:border-b-0 lg:border-r flex items-center justify-center min-h-[300px]">
                <img src="images/lifestyle_hero.png" alt="Diagram operasional unit Lifestyle Ocean Space" className="h-full w-full object-cover" loading="lazy" decoding="async" />
                <div className="absolute bottom-6 left-6 z-20 pr-4">
                  ...
                  <p className="mt-2 rounded bg-white px-2 text-sm font-medium leading-relaxed text-slate-600 shadow-sm">Memberi pengalaman berkualitas.</p>
                </div>
              </div>
              <div className="px-6 py-8 sm:px-8 bg-white">
                ...
                <div className="mt-6 grid gap-4 sm:grid-cols-2">
                  <article className="group rounded-xl border border-slate-100 bg-slate-50 px-5 py-5 transition-all duration-300 hover:bg-white hover:border-slate-300 hover:shadow-sm">
                    ...
                    <h3 className="mt-2 text-[1.1rem] font-extrabold tracking-tight text-slate-900">Produk, Layanan, dan Pengalaman Lifestyle yang Aman, Transparan, dan Bertanggung Jawab</h3>
                    <p className="mt-1 text-sm font-medium leading-relaxed text-slate-500">kepada pelanggan, mitra, dan komunitas.</p>
                  </article>
                  <article className="group rounded-xl border border-slate-100 bg-slate-50 px-5 py-5 transition-all duration-300 hover:bg-white hover:border-slate-300 hover:shadow-sm">
                    <p className="font-mono text-[0.64rem] uppercase tracking-widest text-slate-400 group-hover:text-slate-800 transition-colors">02</p>
                    <h3 className="mt-2 text-[1.1rem] font-extrabold tracking-tight text-slate-900">Standar Layanan dan Operasional yang Unggul, Konsisten, dan Profesional</h3>
                    <p className="mt-1 text-sm font-medium leading-relaxed text-slate-500">di setiap unit usaha.</p>
                  </article>
                  <article className="group rounded-xl border border-slate-100 bg-slate-50 px-5 py-5 transition-all duration-300 hover:bg-white hover:border-slate-300 hover:shadow-sm">
                    ...
                    <p className="mt-1 text-sm font-medium leading-relaxed text-slate-500">dengan pelanggan serta lingkungan kerja yang aman, adil, dan bertumbuh bagi tim.</p>
                  </article>
                  <article className="group rounded-xl border border-slate-100 bg-slate-50 px-5 py-5 transition-all duration-300 hover:bg-white hover:border-slate-300 hover:shadow-sm">
                    <p className="font-mono text-[0.64rem] uppercase tracking-widest text-slate-400 group-hover:text-slate-800 transition-colors">04</p>
                    <h3 className="mt-2 text-[1.1rem] font-extrabold tracking-tight text-slate-900">Unit Usaha dan Komunitas</h3>
                    <p className="mt-1 text-sm font-medium leading-relaxed text-slate-500">dikembangkan secara bertahap, disiplin, dan berkelanjutan sesuai kebutuhan pasar dan nilai perusahaan.</p>
                  </article>
                </div>
              </div>
            </div>
            <div className="relative z-10 mt-3 sm:mt-4 grid gap-3 overflow-hidden rounded-2xl border border-slate-200 bg-white px-6 py-5 text-sm font-medium text-slate-600 shadow-sm sm:grid-cols-3">
              <p className="flex items-start gap-2"><svg className="size-5 shrink-0 text-slate-800/70" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" /></svg> Pengalaman berkualitas.</p>
              <p className="flex items-start gap-2"><svg className="size-5 shrink-0 text-slate-800/70" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" /></svg> Kejujuran.</p>
              <p className="flex items-start gap-2"><svg className="size-5 shrink-0 text-slate-800/70" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" /></svg> Kinerja unggul.</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div data-motion-reveal="panel" className="relative overflow-hidden rounded-3xl border border-slate-200/60 bg-slate-50 p-2 sm:p-4 shadow-sm">
            <div className="relative z-10 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm flex flex-col">
              <div className="group grid gap-4 border-b border-slate-100 px-6 py-5 last:border-b-0 sm:grid-cols-[3rem_minmax(0,1fr)] sm:items-start hover:bg-slate-50 transition-colors">
                <p className="font-mono text-[1.75rem] font-extrabold tracking-tight text-slate-300 group-hover:text-slate-800 transition-colors">01</p>
                <p className="text-sm font-medium leading-relaxed text-slate-600">Menyediakan produk, layanan, dan pengalaman lifestyle yang aman, transparan, dan bertanggung jawab kepada pelanggan, mitra, dan komunitas.</p>
              </div>
              <div className="group grid gap-4 border-b border-slate-100 px-6 py-5 last:border-b-0 sm:grid-cols-[3rem_minmax(0,1fr)] sm:items-start hover:bg-slate-50 transition-colors">
                <p className="font-mono text-[1.75rem] font-extrabold tracking-tight text-slate-300 group-hover:text-[#0062FF] transition-colors">02</p>
                <p className="text-sm font-medium leading-relaxed text-slate-600">Menghadirkan standar layanan dan operasional yang unggul, konsisten, dan profesional di setiap unit usaha.</p>
              </div>
              <div className="group grid gap-4 border-b border-slate-100 px-6 py-5 last:border-b-0 sm:grid-cols-[3rem_minmax(0,1fr)] sm:items-start hover:bg-slate-50 transition-colors">
                <p className="font-mono text-[1.75rem] font-extrabold tracking-tight text-slate-300 group-hover:text-slate-800 transition-colors">03</p>
                <p className="text-sm font-medium leading-relaxed text-slate-600">Membangun hubungan jangka panjang dengan pelanggan serta menciptakan lingkungan kerja yang aman, adil, dan bertumbuh bagi tim.</p>
              </div>
              <div className="group grid gap-4 border-b border-slate-100 px-6 py-5 last:border-b-0 sm:grid-cols-[3rem_minmax(0,1fr)] sm:items-start hover:bg-slate-50 transition-colors">
                <p className="font-mono text-[1.75rem] font-extrabold tracking-tight text-slate-300 group-hover:text-[#0062FF] transition-colors">04</p>
                <p className="text-sm font-medium leading-relaxed text-slate-600">Mengembangkan unit usaha dan komunitas secara bertahap, disiplin, dan berkelanjutan sesuai kebutuhan pasar dan nilai perusahaan.</p>
              </div>
              <div className="group grid gap-4 border-b border-slate-100 px-6 py-5 last:border-b-0 sm:grid-cols-[3rem_minmax(0,1fr)] sm:items-start hover:bg-slate-50 transition-colors">
                <p className="font-mono text-[1.75rem] font-extrabold tracking-tight text-slate-300 group-hover:text-slate-800 transition-colors">05</p>
                <p className="text-sm font-medium leading-relaxed text-slate-600">Menyelesaikan setiap komitmen layanan, kegiatan operasional, dan tanggung jawab sosial dengan tuntas dan dapat dipertanggungjawabkan.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="lc-shell relative py-14 sm:py-16 lg:py-20">
        ...
        <div className="mt-10 grid gap-4 lg:grid-cols-3">
          <article className="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-8 shadow-sm transition-all duration-300 hover:border-slate-300 hover:shadow-md">
            ...
            <h3 className="mt-8 text-[1.5rem] font-extrabold tracking-tight text-slate-900 leading-tight">Kelompok Usaha Lifestyle yang Dipercaya</h3>
            <p className="mt-3 text-sm font-medium leading-relaxed text-slate-600">Menjadi kelompok usaha lifestyle yang dipercaya.</p>
            <div className="mt-8 border-t border-slate-100 pt-5">
              <p className="font-mono text-[0.64rem] uppercase tracking-widest text-slate-400">Inti</p>
              <p className="mt-1 text-sm font-bold text-slate-900">Dipercaya.</p>
            </div>
          </article>
          <article className="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-8 shadow-sm transition-all duration-300 hover:border-slate-300 hover:shadow-md">
          ...
          <article className="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-8 shadow-sm transition-all duration-300 hover:border-slate-300 hover:shadow-md">
            ...
            <h3 className="mt-8 text-[1.5rem] font-extrabold tracking-tight text-slate-900 leading-tight">Layanan, Operasional, dan Tanggung Jawab Sosial</h3>
            <p className="mt-3 text-sm font-medium leading-relaxed text-slate-600">Menyelesaikan setiap komitmen layanan, kegiatan operasional, dan tanggung jawab sosial dengan tuntas dan dapat dipertanggungjawabkan.</p>
            <div className="mt-8 border-t border-slate-100 pt-5">
              <p className="font-mono text-[0.64rem] uppercase tracking-widest text-slate-400">Inti</p>
              <p className="mt-1 text-sm font-bold text-slate-900">Tanggung jawab sosial.</p>
            </div>
          </article>
        </div>
      </div>
