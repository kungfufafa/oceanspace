          ...
          <div className="lc-shell py-14 sm:py-16 lg:py-20">
            ...
            <div className="lc-hero-grid grid gap-10 lg:grid-cols-[minmax(0,0.96fr)_minmax(22rem,0.84fr)] lg:items-center lg:gap-12">
              <MotionReveal yOffset={25} className="lc-hero-copy max-w-[40rem]">
                ...
                <h1 className="lc-hero-title mt-4 max-w-full sm:max-w-[15ch] font-display text-[clamp(2.55rem,4.6vw,4rem)] font-[500] leading-[0.94] tracking-[-0.05em] text-[#171a22]">Jaringan toko yang lebih dekat dengan pelanggan.</h1>
                <p className="lc-hero-body mt-5 max-w-[33rem] text-[1rem] leading-8 text-[#556070]">Complite+, Unboxing, dan Complete Selular menyapa pelanggan di berbagai wilayah.</p>
                <div className="lc-brand-shelf" aria-label="Brand unit Sub Retail">
                  <p className="lc-brand-kicker">Jaringan Brand</p>
                  <MotionStagger className="lc-brand-grid">
                    <MotionStaggerItem>
                      <MotionCard className="lc-brand-card">
                        ...
                        <p className="lc-brand-name">Complite+</p>
                      </MotionCard>
                    </MotionStaggerItem>
                    <MotionStaggerItem>
                      <MotionCard className="lc-brand-card">
                        ...
                        <p className="lc-brand-name">Unboxing</p>
                      </MotionCard>
                    </MotionStaggerItem>
                    <MotionStaggerItem>
                      <MotionCard className="lc-brand-card">
                  ...
                  <div className="relative z-10 grid gap-3 sm:gap-4 sm:grid-cols-[minmax(0,1.2fr)_minmax(11rem,0.8fr)]">
                    <div className="flex flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
                      <div className="flex items-center justify-between border-b border-slate-100 px-5 py-4 text-sm bg-white">
                        <div className="flex items-center gap-3"><span className="os-pulse-dot h-2 w-2 rounded-full bg-[#1e40af] text-[#1e40af]"></span><span className="font-bold tracking-tight text-slate-900">Sub Retail Matrix</span></div>
                      ...
                      <div className="relative flex-1 overflow-hidden bg-white flex items-center justify-center p-0 aspect-[1.12/1]">
                        <img src="/images/subretail_hero_cover.png" alt="Sub Retail Operations" className="h-full w-full object-cover transition-transform duration-1000 hover:scale-105" loading="eager" />
                      </div>
                    </div>
                    <div className="grid gap-3 sm:gap-4">
                      <MotionCard className="group rounded-2xl border border-slate-200 bg-white px-6 py-5 shadow-sm">
                        <p className="font-mono text-[0.66rem] uppercase tracking-widest text-slate-500 transition-colors group-hover:text-[#1e40af]">Brand Network</p>
                        <p className="mt-2 text-[2.5rem] font-extrabold tracking-tight text-slate-900 leading-none">3</p>
                      </MotionCard>
                    </div>
                  </div>
                </div>
      ...
      <footer className="border-t border-[#d8e0ec] bg-white text-[#121826]">
        <div className="lc-shell py-14 sm:py-16">
          <div className="grid gap-4 text-sm text-[#6b7280] sm:grid-cols-2 sm:items-center">
            <p>&copy; <span data-year></span> Ocean Space | Sub Retail</p>
