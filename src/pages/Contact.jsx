  ...
  return (
    <div className="relative min-h-screen flex flex-col justify-between bg-white">
      ...
      <main id="main-content" tabIndex={-1} className="w-full flex-1">
        ...
        <section className="relative overflow-hidden border-b border-black/10 bg-white py-14 sm:py-18 lg:py-24">
          ...
          <div className="lc-shell relative z-10">
            <div className="grid gap-12 lg:grid-cols-12 lg:items-start lg:gap-14">
              ...
              >
                <p className="lc-eyebrow">Kontak & Lokasi</p>
                ...
                <p className="mt-4 text-[1.02rem] leading-relaxed text-[#556070] max-w-lg">
                  Diskusikan kemitraan bisnis, ekspansi distribusi ritel, atau pertanyaan umum dengan tim manajemen korporat kami.
                </p>
                ...
                <div className="mt-8 space-y-4">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex flex-wrap items-center justify-between gap-2">
                          <span className="text-[0.7rem] font-bold uppercase tracking-wider text-[#1d4ed8]">Head Office · Jakarta</span>
                  ...
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex flex-wrap items-center justify-between gap-2">
                          <span className="text-[0.7rem] font-bold uppercase tracking-wider text-[#1d4ed8]">Head Office · Cirebon</span>
              ...
              >
                <div className="rounded-3xl border border-slate-200 bg-white p-7 sm:p-9 shadow-sm">
                  <div className="flex items-center justify-between border-b border-slate-100 pb-5">
                    <div>
                      <h2 className="text-xl sm:text-2xl font-bold tracking-tight text-[#171a22]">Kirim Pesan Korporat</h2>
                      <p className="mt-1 text-xs sm:text-sm text-[#556070]">
                        Respon cepat melalui saluran resmi komunikasi kami.
                      </p>
                    </div>
                  ...
                  {isSubmitted ? (
                    <div className="mt-6 rounded-2xl bg-blue-50/60 border border-blue-100 p-6 sm:p-8 text-center">
                      ...
                      <h3 className="text-base font-bold text-slate-900">Membuka WhatsApp Korporat...</h3>
                      <p className="mt-1.5 text-xs text-slate-600 leading-relaxed max-w-sm mx-auto">
                        Pesan Anda siap dikirimkan. Jika percakapan WhatsApp tidak terbuka otomatis, silakan klik tombol di bawah.
                      </p>
                    ...
                    <form className="mt-6 space-y-4" onSubmit={handleSubmit}>
                      <div>
                        <label className="block text-xs font-semibold text-[#344054] mb-1.5">Nama Lengkap</label>
                        <input
                          type="text"
                          required
                          value={formData.name}
                      ...
                      <div>
                        <label className="block text-xs font-semibold text-[#344054] mb-1.5">Email Bisnis / Pribadi</label>
                        <input
                          type="email"
                          required
                      ...
                      <div>
                        <label className="block text-xs font-semibold text-[#344054] mb-1.5">Pesan / Keperluan</label>
                        <textarea
                          rows={4}
                          required
                          ...
                          placeholder="Tuliskan pesan, tujuan kolaborasi, atau pertanyaan Anda..."
                        ></textarea>
                      </div>
                      <motion.button
        ...
        {/* 2. BENTO GRID ARSITEKTURAL: FASILITAS & SUASANA KANTOR */}
          ...
          <div className="lc-shell relative z-10">
            <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between lg:gap-6 mb-12 sm:mb-16">
              <MotionReveal className="max-w-[36rem]">
                <p className="lc-eyebrow">Fasilitas & Lingkungan Kerja</p>
                <h2 className="mt-3 font-display text-[clamp(2rem,3.4vw,3.2rem)] font-[500] leading-[0.98] tracking-[-0.045em] text-[#171a22]">
                  Ruang Kerja & Kolaborasi Terpadu.
                </h2>
              </MotionReveal>
              <MotionReveal delay={0.1} className="max-w-[28rem] text-[0.98rem] leading-7 text-[#596171]">
                Fasilitas kantor representatif yang dirancang untuk mendukung operasional profesional, transparansi, dan sinergi seluruh unit grup Ocean Space.
              </MotionReveal>
            </div>
            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-12 lg:gap-6">
              ...
              {/* 1. HERO BENTO CARD: LOBBY UTAMA (Tall Left Focal Point) */}
              <MotionReveal className="lg:col-span-5 h-full">
                <div
                  onClick={() =>
                    setSelectedImage({
                      title: 'Lobi Utama & Lounge Tamu',
                ...
                >
                  ...
                  <div className="relative z-10 p-6 sm:p-8 mt-auto">
                    ...
                    <p className="mt-2 text-xs sm:text-sm text-slate-200/90 max-w-md">
                      Area penerimaan tamu dan lounge resmi Ocean Space.
                    </p>
              ...
              {/* RIGHT BENTO SUB-GRID (7 Columns) */}
              <div className="lg:col-span-7 flex flex-col gap-6">
                
                {/* 2. TOP RIGHT CARD: FASAD & AKSES KANTOR (Wide Cinematic Card) */}
                <MotionReveal delay={0.06}>
                  <div
                    onClick={() =>
                      setSelectedImage({
                        title: 'Fasad & Pintu Masuk Gedung',
                  ...
                  >
                    ...
                    <div className="relative z-10 p-5 sm:p-6 mt-auto">
                      ...
                      <h3 className="mt-0.5 text-xl font-bold tracking-tight text-white sm:text-2xl">
                        Akses Masuk & Fasad Gedung
                      </h3>
                      <p className="mt-1 text-xs sm:text-[0.84rem] text-slate-200/90">
                        Akses utama dan fasad gedung kantor operasional.
                      </p>
                    </div>
                  </div>
                </MotionReveal>

                {/* 3 & 4. BOTTOM DUAL CARDS: SMART BOARDROOM & CREATIVE COLLAB ROOM */}
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                  ...
                  <MotionReveal delay={0.12}>
                    ...
                    >
                      ...
                      <div className="relative z-10 p-5 mt-auto">
                        ...
                        <h3 className="mt-0.5 text-lg font-bold text-white">Smart Meeting Room</h3>
                        <p className="mt-1 text-xs text-slate-200/90">
                          Ruang rapat eksekutif dengan display interaktif.
                        </p>
                      </div>
                    </div>
                  </MotionReveal>
                  ...
                  <MotionReveal delay={0.16}>
                    <div
                      onClick={() =>
                        setSelectedImage({
                          title: 'Creative Discussion Room',
                    ...
                    >
                      ...
                      <div className="relative z-10 p-5 mt-auto">
                        ...
                        <h3 className="mt-0.5 text-lg font-bold text-white">Collaboration Room</h3>
                        <p className="mt-1 text-xs text-slate-200/90">
                          Ruang diskusi dan brainstorming kreatif tim.
                        </p>
                      </div>
                    </div>
                  </MotionReveal>
      ...
      {/* 3. LIGHTBOX MODAL FULLSCREEN VIA PORTAL (BALANCED TRANSLUCENT OVERLAY) */}
      {selectedImage && typeof document !== 'undefined' && createPortal(
        ...
        >
          ...
          {/* Direct Floating Photo (Clicking photo will not close) */}
          <div
