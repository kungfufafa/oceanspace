      ...
      <div className="lc-shell py-14 sm:py-16 lg:py-20">
        ...
        <div className="lc-hero-grid grid gap-10 lg:grid-cols-[minmax(0,0.96fr)_minmax(22rem,0.84fr)] lg:items-center lg:gap-12">
          <div className="lc-hero-copy max-w-[40rem]">
            <p data-motion-enter="eyebrow" className="lc-eyebrow">Unit Bisnis: Retail</p>
            <h1 data-motion-enter="heading" className="lc-hero-title mt-4 max-w-full sm:max-w-[15ch] font-display text-[clamp(2.55rem,4.6vw,4rem)] font-[500] leading-[0.94] tracking-[-0.05em] text-[#171a22]">Menjadi retail handphone dan aksesoris yang paling dipercaya pelanggan.</h1>
            <p data-motion-enter="summary" className="lc-hero-body mt-5 max-w-[33rem] text-[1rem] leading-8 text-[#556070]">Kejujuran dan pelayanan unggul, dengan pertumbuhan yang berkelanjutan.</p>
            <div data-motion-enter="meta" className="lc-brand-shelf" aria-label="Entitas unit Retail">
              ...
              <div className="relative z-10 grid gap-3 sm:gap-4 sm:grid-cols-[minmax(0,1.2fr)_minmax(11rem,0.8fr)]">
                <div className="flex flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
                  <div className="flex items-center justify-between border-b border-slate-100 px-5 py-4 text-sm bg-white">
                    <div className="flex items-center gap-3"><span className="h-2 w-2 rounded-full bg-[#FF2D20] shadow-[0_0_8px_rgba(255,45,32,0.4)]"></span><span className="font-bold tracking-tight text-slate-900">Retail Matrix</span></div>
      ...
      <div className="lc-shell relative py-14 sm:py-16 lg:py-20">
        ...
        <div className="grid gap-10 lg:grid-cols-[minmax(0,0.74fr)_minmax(0,1.26fr)] lg:items-start">
          <div data-motion-reveal="intro" className="max-w-[28rem]">
            ...
            <h2 className="mt-3 max-w-full sm:max-w-[14ch] font-display text-[clamp(1.95rem,3.2vw,3rem)] font-[500] leading-[0.98] tracking-[-0.045em] text-[#171a22]">Arah utama unit bisnis Retail.</h2>
          ...
          <div data-motion-reveal="panel" className="relative overflow-hidden rounded-3xl border border-slate-200/60 bg-slate-50 p-2 sm:p-4 shadow-sm">
            <div className="relative z-10 grid overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm lg:grid-cols-[minmax(14rem,0.85fr)_minmax(0,1.15fr)]">
              <div className="relative overflow-hidden border-b border-slate-100 bg-slate-50 lg:border-b-0 lg:border-r flex items-center justify-center min-h-[300px]">
                ...
                <div className="absolute bottom-6 left-6 z-20 pr-4">
                  ...
                  <p className="mt-2 rounded bg-white px-2 text-sm font-medium leading-relaxed text-slate-600 shadow-sm">Retail handphone dan aksesoris.</p>
                </div>
              </div>
              <div className="px-6 py-8 sm:px-8 bg-white">
                ...
                <div className="mt-6 grid gap-4 sm:grid-cols-2">
                  <article className="group rounded-xl border border-slate-100 bg-slate-50 px-5 py-5 transition-all duration-300 hover:bg-white hover:border-slate-300 hover:shadow-sm">
                    ...
                    <h3 className="mt-2 text-[1.1rem] font-extrabold tracking-tight text-slate-900">Produk Handphone dan Aksesoris yang Asli</h3>
                    <p className="mt-1 text-sm font-medium leading-relaxed text-slate-500">bergaransi jelas, dengan informasi harga dan spesifikasi yang transparan kepada pelanggan.</p>
                  </article>
                  <article className="group rounded-xl border border-slate-100 bg-slate-50 px-5 py-5 transition-all duration-300 hover:bg-white hover:border-slate-300 hover:shadow-sm">
                    ...
                    <h3 className="mt-2 text-[1.1rem] font-extrabold tracking-tight text-slate-900">Pelayanan Cepat, Tepat, dan Profesional</h3>
                    <p className="mt-1 text-sm font-medium leading-relaxed text-slate-500">melalui standar operasional yang konsisten serta tim yang terlatih dan bertanggung jawab.</p>
                  </article>
                  <article className="group rounded-xl border border-slate-100 bg-slate-50 px-5 py-5 transition-all duration-300 hover:bg-white hover:border-slate-300 hover:shadow-sm">
                    ...
                    <p className="mt-1 text-sm font-medium leading-relaxed text-slate-500">dengan pelanggan serta lingkungan kerja yang saling menghargai, adil, dan aman bagi seluruh tim.</p>
                  </article>
                  <article className="group rounded-xl border border-slate-100 bg-slate-50 px-5 py-5 transition-all duration-300 hover:bg-white hover:border-slate-300 hover:shadow-sm">
                    ...
                    <h3 className="mt-2 text-[1.1rem] font-extrabold tracking-tight text-slate-900">Jaringan Toko, Kualitas Layanan, dan Kompetensi Tim</h3>
                    <p className="mt-1 text-sm font-medium leading-relaxed text-slate-500">dikembangkan secara bertahap, disiplin, dan berkelanjutan.</p>
                  </article>
                </div>
              </div>
            </div>
            <div className="relative z-10 mt-3 sm:mt-4 grid gap-3 overflow-hidden rounded-2xl border border-slate-200 bg-white px-6 py-5 text-sm font-medium text-slate-600 shadow-sm sm:grid-cols-3">
              <p className="flex items-start gap-2"><svg className="size-5 shrink-0 text-[#FF2D20]/70" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" /></svg> Kejujuran.</p>
              <p className="flex items-start gap-2"><svg className="size-5 shrink-0 text-[#FF2D20]/70" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" /></svg> Pelayanan unggul.</p>
              <p className="flex items-start gap-2"><svg className="size-5 shrink-0 text-[#FF2D20]/70" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" /></svg> Pertumbuhan yang berkelanjutan.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="lc-shell relative py-14 sm:py-16 lg:py-20">
        ...
        <div className="grid gap-10 lg:grid-cols-[minmax(0,0.72fr)_minmax(0,1.28fr)] lg:items-start">
          <div data-motion-reveal="intro" className="max-w-[28rem]">
            ...
            <h2 className="mt-3 max-w-full sm:max-w-[14ch] font-display text-[clamp(1.95rem,3.2vw,3rem)] font-[500] leading-[0.98] tracking-[-0.045em] text-[#171a22]">Lima misi unit bisnis Retail.</h2>
          ...
          <div data-motion-reveal="panel" className="relative overflow-hidden rounded-3xl border border-slate-200/60 bg-slate-50 p-2 sm:p-4 shadow-sm">
            <div className="relative z-10 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm flex flex-col">
              <div className="group grid gap-4 border-b border-slate-100 px-6 py-5 last:border-b-0 sm:grid-cols-[3rem_minmax(0,1fr)] sm:items-start hover:bg-slate-50 transition-colors">
                ...
                <p className="text-sm font-medium leading-relaxed text-slate-600">Menyediakan produk handphone dan aksesoris yang asli, bergaransi jelas, dengan informasi harga dan spesifikasi yang transparan kepada pelanggan.</p>
              </div>
              <div className="group grid gap-4 border-b border-slate-100 px-6 py-5 last:border-b-0 sm:grid-cols-[3rem_minmax(0,1fr)] sm:items-start hover:bg-slate-50 transition-colors">
                ...
                <p className="text-sm font-medium leading-relaxed text-slate-600">Memberikan pelayanan cepat, tepat, dan profesional melalui standar operasional yang konsisten serta tim yang terlatih dan bertanggung jawab.</p>
              </div>
              <div className="group grid gap-4 border-b border-slate-100 px-6 py-5 last:border-b-0 sm:grid-cols-[3rem_minmax(0,1fr)] sm:items-start hover:bg-slate-50 transition-colors">
                ...
                <p className="text-sm font-medium leading-relaxed text-slate-600">Membangun hubungan jangka panjang dengan pelanggan serta menciptakan lingkungan kerja yang saling menghargai, adil, dan aman bagi seluruh tim.</p>
              </div>
              <div className="group grid gap-4 border-b border-slate-100 px-6 py-5 last:border-b-0 sm:grid-cols-[3rem_minmax(0,1fr)] sm:items-start hover:bg-slate-50 transition-colors">
                ...
                <p className="text-sm font-medium leading-relaxed text-slate-600">Mengembangkan jaringan toko, kualitas layanan, dan kompetensi tim secara bertahap, disiplin, dan berkelanjutan.</p>
              </div>
              <div className="group grid gap-4 border-b border-slate-100 px-6 py-5 last:border-b-0 sm:grid-cols-[3rem_minmax(0,1fr)] sm:items-start hover:bg-slate-50 transition-colors">
                ...
                <p className="text-sm font-medium leading-relaxed text-slate-600">Menyelesaikan setiap transaksi, layanan purna jual, dan komitmen kepada pelanggan dengan tuntas dan bertanggung jawab.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="lc-shell relative py-14 sm:py-16 lg:py-20">
        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-[32rem]">
            ...
            <h2 className="mt-3 max-w-full sm:max-w-[17ch] font-display text-[clamp(1.95rem,3.2vw,3rem)] font-[500] leading-[0.98] tracking-[-0.045em] text-[#171a22]">Menjadi retail handphone dan aksesoris yang paling dipercaya pelanggan melalui kejujuran, pelayanan unggul, dan pertumbuhan berkelanjutan.</h2>
          </div>
          <p className="max-w-[24rem] text-[0.98rem] leading-7 text-[#596171]">Kejujuran dan pelayanan unggul, dengan pertumbuhan yang berkelanjutan.</p>
        </div>
        <div className="mt-10 grid gap-4 lg:grid-cols-3">
          <article className="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-8 shadow-sm transition-all duration-300 hover:border-slate-300 hover:shadow-md">
            ...
            <h3 className="mt-8 text-[1.5rem] font-extrabold tracking-tight text-slate-900 leading-tight">Paling Dipercaya Pelanggan</h3>
            <p className="mt-3 text-sm font-medium leading-relaxed text-slate-600">Menjadi retail handphone dan aksesoris yang paling dipercaya pelanggan.</p>
            <div className="mt-8 border-t border-slate-100 pt-5">
              <p className="font-mono text-[0.64rem] uppercase tracking-widest text-slate-400">Inti</p>
              <p className="mt-1 text-sm font-bold text-slate-900">Dipercaya pelanggan.</p>
            </div>
          </article>
          <article className="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-8 shadow-sm transition-all duration-300 hover:border-slate-300 hover:shadow-md">
            ...
            <p className="font-mono text-[0.66rem] uppercase tracking-widest text-[#FF2D20]">Produk</p>
            <h3 className="mt-8 text-[1.5rem] font-extrabold tracking-tight text-slate-900 leading-tight">Handphone dan Aksesoris yang Asli</h3>
            <p className="mt-3 text-sm font-medium leading-relaxed text-slate-600">Menyediakan produk handphone dan aksesoris yang asli, bergaransi jelas, dengan informasi harga dan spesifikasi yang transparan kepada pelanggan.</p>
            <div className="mt-8 border-t border-slate-100 pt-5">
              <p className="font-mono text-[0.64rem] uppercase tracking-widest text-slate-400">Inti</p>
              <p className="mt-1 text-sm font-bold text-slate-900">Produk yang asli.</p>
            </div>
          </article>
          <article className="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-8 shadow-sm transition-all duration-300 hover:border-slate-300 hover:shadow-md">
            ...
            <h3 className="mt-8 text-[1.5rem] font-extrabold tracking-tight text-slate-900 leading-tight">Transaksi dan Purna Jual Tuntas</h3>
            <p className="mt-3 text-sm font-medium leading-relaxed text-slate-600">Menyelesaikan setiap transaksi, layanan purna jual, dan komitmen kepada pelanggan dengan tuntas dan bertanggung jawab.</p>
            <div className="mt-8 border-t border-slate-100 pt-5">
              <p className="font-mono text-[0.64rem] uppercase tracking-widest text-slate-400">Inti</p>
              <p className="mt-1 text-sm font-bold text-slate-900">Tuntas dan bertanggung jawab.</p>
            </div>
          </article>
        </div>
      </div>
