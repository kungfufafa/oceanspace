          ...
          <div className="lc-shell py-14 sm:py-16 lg:py-20">
            ...
            <div className="lc-hero-grid grid gap-10 lg:grid-cols-[minmax(0,0.96fr)_minmax(22rem,0.84fr)] lg:items-center lg:gap-12">
              <MotionReveal yOffset={25} className="lc-hero-copy max-w-[40rem]">
                <p className="lc-eyebrow">Unit Bisnis: Retail</p>
                <h1 className="lc-hero-title mt-4 max-w-full sm:max-w-[15ch] font-display text-[clamp(2.55rem,4.6vw,4rem)] font-[500] leading-[0.94] tracking-[-0.05em] text-[#171a22]">Menjadi retail handphone dan aksesoris yang paling dipercaya pelanggan.</h1>
                <p className="lc-hero-body mt-5 max-w-[33rem] text-[1rem] leading-8 text-[#556070]">Kejujuran dan pelayanan unggul, dengan pertumbuhan yang berkelanjutan.</p>
                <div className="lc-brand-shelf" aria-label="Entitas unit Retail">
                  ...
                  <div className="relative z-10 grid gap-3 sm:gap-4 sm:grid-cols-[minmax(0,1.2fr)_minmax(11rem,0.8fr)]">
                    <div className="flex flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
                      <div className="flex items-center justify-between border-b border-slate-100 px-5 py-4 text-sm bg-white">
                        <div className="flex items-center gap-3"><span className="os-pulse-dot h-2 w-2 rounded-full bg-[#1e40af] text-[#1e40af]"></span><span className="font-bold tracking-tight text-slate-900">Retail Matrix</span></div>
                      ...
                      <div className="relative flex-1 overflow-hidden bg-white flex items-center justify-center p-0 aspect-[1.12/1]">
                        <img src="/images/retail_hero_cover.png" alt="Retail Operations" className="h-full w-full object-cover transition-transform duration-1000 hover:scale-105" loading="eager" />
                      </div>
                    </div>
                    <div className="grid gap-3 sm:gap-4">
                      ...
                      <MotionCard className="group rounded-2xl border border-slate-200 bg-white px-6 py-5 shadow-sm">
                        <p className="font-mono text-[0.66rem] uppercase tracking-widest text-slate-500 transition-colors group-hover:text-[#0062FF]">Layanan</p>
                        <p className="mt-2 text-[1.4rem] font-extrabold tracking-tight text-slate-900 leading-none">Omnichannel</p>
                      </MotionCard>
                    </div>
                  </div>
                </div>
        ...
        <section className="lc-band bg-[#f6f9fd]">
          <div className="lc-shell relative py-14 sm:py-16 lg:py-20">
            <MotionReveal className="max-w-[32rem]">
              <p className="lc-eyebrow">Dua Badan Usaha Retail</p>
              <h2 className="mt-3 font-display text-[clamp(1.95rem,3.2vw,3rem)] font-[500] leading-[0.98] tracking-[-0.045em] text-[#171a22]">Entitas Operasional Retail.</h2>
            </MotionReveal>
            <MotionStagger className="mt-10 grid gap-6 sm:grid-cols-2">
              <MotionStaggerItem>
                <MotionCard className="border border-[#d9e2ef] bg-white p-6 sm:p-8 rounded-2xl shadow-sm">
                  <h3 className="text-xl font-bold text-[#171a22]">PT. Retail Indonesia Selalu Maju</h3>
                  <p className="mt-3 text-sm leading-6 text-[#596171]">Mengelola outlet retail fisik dengan pelayanan ramah dan produk original bergaransi resmi.</p>
                </MotionCard>
              </MotionStaggerItem>
              <MotionStaggerItem>
                <MotionCard className="border border-[#d9e2ef] bg-white p-6 sm:p-8 rounded-2xl shadow-sm">
                  <h3 className="text-xl font-bold text-[#171a22]">PT. Complete Solusi Nusantara</h3>
                  <p className="mt-3 text-sm leading-6 text-[#596171]">Solusi ekosistem retail terpadu yang menghubungkan kanal penjualan langsung dan digital.</p>
                </MotionCard>
              </MotionStaggerItem>
            </MotionStagger>
          </div>
      ...
      <footer className="border-t border-[#d8e0ec] bg-white text-[#121826]">
        <div className="lc-shell py-14 sm:py-16">
          <div className="grid gap-4 text-sm text-[#6b7280] sm:grid-cols-2 sm:items-center">
            <p>&copy; <span data-year></span> Ocean Space | Retail</p>
